...
import 'package:bitechronicle/view/login/complete_profile_view.dart';
import 'package:bitechronicle/view/login/login_view.dart';
            ...
            child: SafeArea(
              child: Column(
                ...
                children: [
                  ...
                  const RoundTextField(
                      hitText: "Last Name", icon: "assets/img/user_text.png"),
                  SizedBox(
                    height: media.width * 0.04,
                  ),
                  const RoundTextField(
